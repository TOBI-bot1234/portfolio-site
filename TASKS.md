...
- Cursor art — placeholder 16x16 pixel arrow + pointing-hand are live in `assets/`. Swap the PNGs (same filenames, 16x16 RGBA) for a different pixel style if you want.
